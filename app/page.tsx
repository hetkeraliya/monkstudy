      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            <p className="font-black text-[15px] tracking-wide">
              Deep Work Protocol
            </p>
            <p className="text-xs text-[#ACAD94] font-bold mt-0.5">
              Start 25m Timer
            </p>
          </div>
        </div>
            ...
            >
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="relative w-10 h-10 flex items-center justify-center">
                  ...
                  <span className="absolute text-[9px] font-black text-[#384D48]">
                    {progressPercent}%
                  </span>
                </div>
              </div>
              ...
              <div className="mb-5">
                <p className="text-[10px] font-black text-[#6E7271] uppercase tracking-widest mb-1">
                  Current Focus
                </p>
                <p className="font-bold text-[14px] text-[#111827] mb-3">
              ...
              <div className="flex justify-between items-end mt-2">
                <div>
                  <p className="text-[10px] font-black text-[#6E7271] uppercase tracking-widest mb-0.5">
                    Time Logged
                  </p>
                  <p className="font-bold text-[13px] text-[#384D48]">
